"""
Django settings for ems_40069 project.
...
WSGI_APPLICATION = 'ems_40069.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ems_40069 API",
    "DESCRIPTION": "API documentation for ems_40069 App",
    "VERSION": "v1",
}
